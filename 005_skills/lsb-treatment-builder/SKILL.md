...
Phase 5 후: **6.1** 1분 발표 스크립트(`treatment_client_pitch.md`, 7단계 시간 마킹). **6.2** 핵심 컷 스틸 패키지(`hero_stills/`, 와우컷+표지+키비주얼+클로징 6~8장). **6.3** PDF 옵션 3종(`treatment.pdf` 합본 / `treatment_client.pdf` / `treatment_internal.pdf`). 광고주엔 보통 client + pitch + hero_stills.
